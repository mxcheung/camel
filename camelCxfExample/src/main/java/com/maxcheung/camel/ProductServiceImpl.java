package com.maxcheung.camel;

import java.util.HashMap;
import java.util.Map;

import com.maxcheung.ws.product_service.types.ProductResponse;

public class ProductServiceImpl {
    public ProductResponse getProductDetails(com.maxcheung.ws.product_service.types.ProductRequest request) {
